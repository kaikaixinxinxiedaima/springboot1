...
//import com.test.util.es.ElasticsearchUtil;
//import com.test.util.es.EsPage;
...
//        jsonObject.put("id", new Random().nextInt(100));
//        jsonObject.put("bookName", "测试书籍" + new Random(100).nextInt());
...
//        Book esModel = new Book();
//        esModel.setId(new Random().nextInt(100));
//        esModel.setBookName("测试书籍" + new Random(100).nextInt());
...
//            //不进行分词搜索
//            boolQuery.must(QueryBuilders.matchPhraseQuery("bookName", "书籍"));
//        } else {
//            boolQuery.must(QueryBuilders.matchQuery("bookName", "书籍"));
//        }
//        List<Map<String, Object>> list = ElasticsearchUtil.
//                searchListData(indexName, esType, boolQuery, 10, "bookName", null, "bookName");
